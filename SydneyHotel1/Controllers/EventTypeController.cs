...
namespace SydneyHotel1.Controllers
{
    ...
    public class EventTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,ObjectName")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,ObjectName")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
